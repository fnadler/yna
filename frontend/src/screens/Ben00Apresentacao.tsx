...
/* BEN-00: Apresentação da plataforma (3 slides, etapa 2 do fluxo de
   boas-vindas, entre `Ben00BemVindo.tsx` e o LGPD/sigilo em `/sigilo`).

   Mesma estrutura do `RH00Apresentacao.tsx` (que por sua vez replica este
   arquivo), mas com copy calibrada para quem vai responder a avaliação, não
   para quem a contrata: por que ela existe, o que é protegido e como
   funciona no dia a dia, sem prometer atendimento clínico (o produto,
   depois do recorte NR-1 standalone, é a avaliação anônima em si). O último
   slide leva a "Continuar" para `/sigilo`, não para criação de conta: aqui
   a pessoa ainda não tem conta nenhuma. Isso só acontece depois de
   responder, em `/criar-conta`. */

const slides = [
  {
    image: '/images/slide1.png',
    eyebrow: 'Por que você está aqui',
    title: 'Sua empresa quer te ouvir',
    highlight: 'te ouvir',
    body: 'A NR-1 obriga toda empresa a avaliar como o trabalho afeta a saúde mental do time. Você foi convidado a responder essa avaliação, e é a sua resposta que vai mostrar como as coisas realmente estão.',
  },
  {
    image: '/images/slide2.png',
    eyebrow: 'Sua privacidade',
    title: 'Suas respostas são só suas',
    highlight: 'só suas',
    body: 'Ninguém da sua empresa vê o que você respondeu individualmente. O RH só recebe números agregados, de grupos com no mínimo 4 pessoas. Nunca o retrato de uma pessoa só.',
  },
  {
    image: '/images/slide3.png',
    eyebrow: 'Como funciona',
    title: 'Leva poucos minutos',
    highlight: 'poucos minutos',
    body: 'Você responde no seu ritmo, sem precisar de conta. No final, se quiser acompanhar sua própria evolução ao longo do tempo, pode criar uma conta leve.',
  },
]
...
export function Ben00Apresentacao() {
  ...
  const handleNext = () => {
    if (isLast) navigate('/sigilo')
    else navigate(`/apresentacao/${step + 1}`)
  }
