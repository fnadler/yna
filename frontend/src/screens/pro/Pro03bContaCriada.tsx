...
/* PRO-03b — Transição "Conta criada" (mesmo modelo do Ben08bTransicao).
   Faz a ponte do Cadastro da conta para o Onboarding do perfil clínico. */
export function Pro03bContaCriada() {
