          ...
          <div className="w-full rounded-2xl bg-surface border border-border shadow p-7 md:p-10 flex flex-col items-center gap-6 animate-yna-slide-up">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-[15px] leading-relaxed text-ink-secondary">
                Agora vamos cadastrar o seu time. Você pode importar uma planilha com todos de uma vez
                ou adicionar pessoa por pessoa. É rápido — e você pode ajustar depois.
              </p>
            </div>
