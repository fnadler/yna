...
export function RH02LinkInvalido() {
  return (
    <section className="px-5 lg:px-0 pt-10 lg:pt-16 pb-10">
      ...
      <div className="mt-8 animate-yna-slide-up">
        ...
        <p className="mt-3 text-[15px] leading-relaxed text-ink-secondary">
          Pode ter expirado ou já ter sido usado. Sem problema — sua CSM na YNA reenvia o
        ...
        <div className="mt-8 flex flex-col gap-3">
          <Button
            ...
            onClick={() => { window.location.href = 'mailto:empresas@yna.com.br?subject=Reenvio de acesso ao painel RH' }}
          >
            Falar com a YNA
          </Button>
        </div>
