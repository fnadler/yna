...
const variantClasses = {
  ...
  gradient: 'bg-yna-gradient dark:bg-none dark:bg-surface-2 dark:border dark:border-border border-0 text-ink-gradient dark:text-ink',
  sunken: 'bg-surface-2 border border-border',
}

const paddingClasses = { md: 'p-4', lg: 'p-6', none: 'p-0 overflow-hidden' }
...
export function CardTitle({
  ...
  return (
    <h3 className={`text-lg font-semibold tracking-[-0.01em] text-ink ${className}`}>
      {children}
    </h3>
  )
}
